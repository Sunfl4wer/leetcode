...
public class MinimumFallingPathSum {
  ...
  public static void main(String[] args) {
    ...
    int[][] testCase2 = { { -19, -1, -96, 48, -94, 36, 16, 55, -42, 37, -59, 6, -32, 96, 95, -58, 13, -34, 94, 85 },
    ...
    int[][] testCase4 = { { -21, 4, -10, -2, 17, 36 }, { -15, -26, 98, -48, 56, -14 }, { -28, -88, 73, 41, 81, -10 },
        { 36, -77, -21, -59, -92, 90 }, { -57, -71, -61, -25, 9, -70 }, { 98, 97, -71, -19, 36, 76 } };
    int[][] testCase5;

    try {
      File myObj = new File("./test-case");
      Scanner myReader = new Scanner(myObj);
      while (myReader.hasNextLine()) {
        String data = myReader.nextLine();
        String[] rows = data.split(";");
        testCase5 = new int[rows.length][rows.length];
